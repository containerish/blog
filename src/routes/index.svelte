	...
	>
		...
		>
			...
			<div class="flex flex-col rounded-b-xl gap-4 p-4 border-4 border-brown-100 bg-brown-100">
				...
				<span>
					Read about the story behind OpenRegistry and how it came to be. This blog walks you
					through the product operations, technicality and the developers behind it.
				</span>
		...
		>
			...
			<div class="flex flex-col rounded-b-xl gap-4 p-4 border-4 border-brown-100 bg-brown-100">
				...
				<span>
					...
					OpenRegistry functions with them. Also a little sneak-peak about collaborations in the
					queue
				</span>
				<div class="flex items-center justify-start">
					<User styles="w-8" />
