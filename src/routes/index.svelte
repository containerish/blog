...
<div class="flex flex-col lg:grid grid-cols-3 gap-5 min-h-[1000px] items-center px-2">
    <div
        ...
        <div class="flex flex-col rounded-b-xl gap-4 p-4 border-4 border-brown-100 bg-brown-100">
            ...
            <span>Read about the story behind OpenRegistry and how it came to be.
                This blog walks you through the product operations, technicality and the developers behind it.
            </span>
